...
kBabblerEggHealth = 400 kBabblerEggArmor = 0 kBabblerEggPointValue = 0
...
kMineHealth = 60	kMineArmor = 10	kMinePointValue = 2
...
kTunnelEntranceHealth = 1300	kTunnelEntranceArmor = 400	kTunnelEntrancePointValue = 15
kMatureTunnelEntranceHealth = 1500	kMatureTunnelEntranceArmor = 600
